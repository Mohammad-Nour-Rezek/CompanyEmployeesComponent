...
namespace CompanyEmployees.API.Utilities
{
    public class EmployeeLinks
    {
        ...
        public LinkResponse TryGenrateLinks(IEnumerable<EmployeeDto> employeesDto, string fields, Guid companyId, HttpContext httpContext)
        {
        ...
        private bool ShouldGenerateLinks(HttpContext httpContext)
        {
            ...
            var hasHateoas = mediaType.MediaType.EndsWith("hateoas+json", StringComparison.InvariantCultureIgnoreCase) || mediaType.MediaType.EndsWith("hateoas+xml", StringComparison.InvariantCultureIgnoreCase);
        ...
        private List<Link> CreateLinksForEmployee(HttpContext httpContext, Guid companyId, Guid id, string fields = "")
        {
            ...
            {
                new Link(_linkGenerator.GetUriByAction(httpContext, "GetEmployee", values: new { companyId, id, fields }), "self", "GET"),
                ...
                new Link(_linkGenerator.GetUriByAction(httpContext, "PatillyUpdateEmployeeForCompany", values: new { companyId, id }), "partially_update_employee", "PATCH")
            };
