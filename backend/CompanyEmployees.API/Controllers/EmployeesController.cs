...
namespace CompanyEmployees.API.Controllers
{
    ...
    public class EmployeesController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetEmployeesForCompany(Guid companyId, [FromQuery] EmployeeParameters employeeParameters)
        {
            ...
            Response.Headers.Add("x-Pagination", JsonConvert.SerializeObject(employees.MetaDataProp));

            var employeesDto = _mapper.Map<IEnumerable<EmployeeDto>>(employees);

            var links = _employeeLinks.TryGenrateLinks(employeesDto, employeeParameters.Fields, companyId, HttpContext);
